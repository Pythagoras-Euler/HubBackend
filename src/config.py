...
default_config = {
    ...
    "active_delivery_timeout_days": 7,
    "truckershub_route_access": False,
    "trackers": [{
        "type": "tracksim",
        "company_id": "",
        "api_token": "",
...
def validateConfig(cfg):
    cfg["truckershub_route_access"] = cfg.get("truckershub_route_access") is True
    timeout = cfg.get('active_delivery_timeout_days', 7)
    cfg['active_delivery_timeout_days'] = timeout if type(timeout) is int and 1 <= timeout <= 365 else 7
